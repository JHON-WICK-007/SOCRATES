...
export default function Hero() {
  // Animation Variants for smooth stagger sequence
  ...
  return (
    <section 
      aria-label="Hero"
      className="relative min-h-screen bg-white text-[#1d1d1f] pt-12 pb-16 px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-between overflow-hidden"
    >
      {/* Subtle radial light highlight behind the product mockup */}
      <div 
      ...
      >
        ...
        <motion.p 
          variants={itemVariants}
          className="max-w-2xl mx-auto text-base sm:text-lg md:text-xl text-[#86868b] font-normal leading-relaxed tracking-normal"
        >
        ...
        {/* 5. Large Product Mockup with gentle float effect */}
        <motion.div
        ...
        >
          <motion.div
            ...
            className="w-full bg-white border border-[#e0e0e0] rounded-2xl sm:rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.05)] overflow-hidden text-left"
          >
            ...
            <div className="p-6 sm:p-10 space-y-6">
              ...
              <div className="bg-[#f5f5f7] rounded-xl p-4 sm:p-5 max-w-xl">
                <div className="flex items-center gap-2 mb-1.5 text-xs font-semibold text-[#86868b] tracking-wide uppercase">
              ...
              {/* Feature / Status Action Items Bar */}
        ...
        <motion.div 
          variants={itemVariants}
          className="mt-12 sm:mt-16 flex flex-col items-center gap-1 text-[#86868b]"
        >
          <motion.div
            animate={{ y: [0, 8, 0] }}
            transition={{
